...
# commend line
'''
python randomcompiler.py --file=Pauli_BeH2_unf --num=1 --list1=1.0,0.0,0.0,0.4,0.6,0.0,0.4,0.3,0.3 --epsilon_list_1=0.1,0.067,0.05,0.04,0.033,0.0286,0.025 --excute_time=0.15 --sampling_time=20
