...
# commend line
'''
python randomcompiler.py --file=Pauli_Na+ --num=1 --list1=1.0,0.0,0.0,0.4,0.6,0.0,0.4,0.3,0.3 --epsilon_list_1=0.133,0.125,0.111,0.1,0.0909,0.0833,0.0769,0.0714,0.0667,0.0625,0.0588,0.0555,0.0526,0.05,0.04,0.033,0.0286,0.025 --excute_time=0.6 --sampling_time=20
