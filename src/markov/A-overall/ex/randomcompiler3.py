...
# jsd1 = calculate_jsd_between_dicts(samples[0], samples[1], 1e-10)
# jsd2 = calculate_jsd_between_dicts(samples[0], samples[2], 1e-10)

# print("JSD between 0 and 1:",jsd1)
# print("JSD between 0 and 1'':",jsd2)
...
# # if there exist multiple conbination of the three transition matrices
# # The color is corresponding to the entry in the lam_list, from the first to last
# # 'b' is always stand for random compiler
# if len(CNOT_numses) == 2:
#     plt.plot(group_acc_reses[0], group_CNOT_numses[0], color='b', label=str(lam_list[0]), marker='x', markersize=16, linewidth=1)
#     plt.plot(group_acc_reses[1], group_CNOT_numses[1], color='g', label=str(lam_list[1]), marker='^', markersize=16, linewidth=1)
#     plt.legend(loc='upper left', fontsize=16)
#     plt.xlabel('accuracy')
#     plt.ylabel('CNOT account')
#     # plt.gca().invert_yaxis()
#     # plt.scatter(CNOT_numses[0], acc_reses[0], c='r')
#     # plt.scatter(CNOT_numses[1], acc_reses[1], c='y')
# if len(CNOT_numses) == 3:
#     plt.plot(group_acc_reses[0], group_CNOT_numses[0], color='b', label=str(lam_list[0]), marker='x', markersize=16, linewidth=1)
#     plt.plot(group_acc_reses[1], group_CNOT_numses[1], color='g', label=str(lam_list[1]), marker='^', markersize=16, linewidth=1)
#     plt.plot(group_acc_reses[2], group_CNOT_numses[2], color='y', label=str(lam_list[2]), marker='o', markersize=16, linewidth=1)
#     plt.legend(loc='upper left', fontsize=16)
#     plt.xlabel('accuracy')
#     plt.ylabel('CNOT account')
#     # plt.scatter(CNOT_numses[0], acc_reses[0], c='r')
#     # plt.scatter(CNOT_numses[1], acc_reses[1], c='y')
#     # plt.scatter(CNOT_numses[2], acc_reses[2], c='g')
# if len(CNOT_numses) == 4:
#     plt.plot(group_acc_reses[0], group_CNOT_numses[0], color='b', label=str(lam_list[0]), marker='x', markersize=16, linewidth=1)
#     plt.plot(group_acc_reses[1], group_CNOT_numses[1], color='g', label=str(lam_list[1]), marker='^', markersize=16, linewidth=1)
#     plt.plot(group_acc_reses[2], group_CNOT_numses[2], color='y', label=str(lam_list[2]), marker='o', markersize=16, linewidth=1)
#     plt.plot(group_acc_reses[3], group_CNOT_numses[3], color='r', label=str(lam_list[3]), marker='s', markersize=16, linewidth=1)
#     plt.legend(loc='upper left', fontsize=16)
#     plt.xlabel('accuracy')
#     plt.ylabel('CNOT account')
#     # plt.scatter(CNOT_numses[0], acc_reses[0], c='r')
...
# print('average gate reduction 0-1', file=output_file)
# print(average_reduction_percentage_01, file=output_file)
# print('average gate reduction 0-2', file=output_file)
# print(average_reduction_percentage_02, file=output_file)
# print('JSD 0-1', file=output_file)
# print(jsd1, file=output_file)
# print('JSD 0-2', file=output_file)
# print(jsd2, file=output_file)
...
# commend line
'''
python randomcompiler.py --file=Pauli_BeH2_f --num=1 --list1=1.0,0.0,0.0,0.4,0.6,0.0,0.4,0.3,0.3 --epsilon_list_1=0.1,0.067,0.05,0.04,0.033,0.0286,0.025 --excute_time=0.785 --sampling_time=20
python randomcompiler.py --file=Pauli_H2O --num=1 --list1=1.0,0.0,0.0,0.4,0.6,0.0,0.4,0.3,0.3 --epsilon_list_1=0.1,0.067,0.05,0.04,0.033,0.0286,0.025 --excute_time=0.785 --sampling_time=20
